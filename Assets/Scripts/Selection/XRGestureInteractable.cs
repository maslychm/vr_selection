...
public class XRGestureInteractable : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        if (m_Scene == "PitckupTest_Shelves_3_Circular_MiniMap" || m_Scene == "Demo2" || m_Scene == "ALLCLUTTERLEVELSCENE_WithEditsAvailbleThroughEditor_WithKeyBoardManagementOfLevels" || m_Scene.ToLower().Contains("minimap"))
    ...
    private void EndHover()
    {
        ...
        if (m_Scene == "PitckupTest_Shelves_3_Circular_MiniMap" || m_Scene == "ALLCLUTTERLEVELSCENE_WithEditsAvailbleThroughEditor_WithKeyBoardManagementOfLevels" || m_Scene == "Demo2" || m_Scene.ToLower().Contains("minimap"))
